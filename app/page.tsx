...
export default function Home() {
  return (
    <div className="h-[100%] bg-background">
      {/* Hero Section */}
      <section className="min-h-[30vh] md:min-h-[50vh] flex items-center justify-center  text-[#004bad] overflow-hidden py-10 bg-white">
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[800px] mx-auto text-muted-foreground md:text-xl md:leading-10 mb-12 animate-fade-in-up animation-delay-400 leading-7 text-center">
